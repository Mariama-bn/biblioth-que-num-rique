// src/views/enseignants/ProfilEnseignant.jsx
...
const ProfilEnseignant = () => {
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      <h1 className="text-2xl font-bold text-blue-800 mb-6">👤 Mon Profil Enseignant</h1>
      ...
      <div className="bg-white rounded-lg shadow p-6 flex flex-col md:flex-row gap-8 items-start">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-sm text-gray-600">Cliquez sur l’icône pour changer</p>
        </div>
